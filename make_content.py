...
PAGE_TUPLE = (
    ...
    Page(
        ...
        "acts",
        "acts",
        content_german="Beim ya¹ Festival in Essen werden Virginia Nicoli, Callum Armstrong, Johannes Winkler, VOX NOSTRA, das ya¹ Ensemble und Tamon Yashima spielen.",
        content_english="Virginia Nicoli, Callum Armstrong, Johannes Winkler, VOX NOSTRA, the ya¹ Ensemble and Tamon Yashima will perform at the ya¹ festival in Essen.",
    ),
    Page(
    ...
    Page(
        ...
        "/",
        "index",
        content_german="Im ya¹ Tagesfestival für aktuelle Musik in Essen-Borbeck performen unterschiedliche Vertreter:innen räumlich und zeitlich getrennter avancierter.",
